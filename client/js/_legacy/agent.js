...
var Agent = (function () {
    ...
    function _systemPrompt(stylePrompt, seqInfo) {
        ...
        return [
            ...
            '- After segments are placed you may polish: call list_sequence_clips to address timeline clips, then use set_audio_gain, add_audio_fade, apply_clip_preset (for Lumetri/color), and set_clip_speed (slow/fast motion). Use these sparingly and only when the user asks for polish.',
            '- Transitions cannot be scripted in this Premiere build. If asked, tell the user to add them manually (Ctrl+D applies the default transition at a cut).',
