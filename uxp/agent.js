...
function systemPrompt(seqInfo) {
    ...
    return [
        ...
        "",
        "Operating model:",
        "- A/V SYNC: move_clips, clone_clip_to_time, and reorder_track all",
        "  automatically apply the same operation to the audio clip on A1",
        "  whose name + start match the video clip on V1. The agent does",
        "  NOT need to plan audio moves separately - V and A stay in sync.",
        "  Silent video clips (no matching audio) are handled correctly.",
